...
- Route the documented orchestration endpoints to real backends and require auth instead of falling through to the SPA ([HeadySystems](https://headysystems.com/), [HeadyMe](https://headyme.com/)).
